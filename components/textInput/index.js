    ...
    <TouchableOpacity
      ...
      <Wrapper
        ...
        {left ? (
          ...
          <Wrapper
            style={{alignItems: 'center', marginLeft: sizes.marginHorizontal}}>
            <Icons.Custom
              icon={customIconLeft}
...
const ColoredNew = ({
  ...
  return (
    <View
      ...
      <View>
        <Text style={{marginLeft:totalSize(0.3),fontSize:totalSize(1.8),fontFamily:fontFamily.appTextBold,color:colors.inputtitleclr}}>{title}</Text>
            ...
            <TextInput
              ...
              onSubmitEditing={onSubmitEditing}
              multiline={multiline}
              placeholderTextColor={colors.welcome}
              keyboardType={keyboardType}
              onFocus={onFocus}
              onBlur={onBlur}
              secureTextEntry={secureTextEntry}
...
const Underlined = ({
  ...
  const FocusedTitleMarginBottom =
    Platform.OS === 'ios' ? height(5) : height(5);
          ...
          <View
            ...
            <Wrapper
              ...
              <Wrapper
                ...
                <Text isInput style={[titleStyle, {lineHeight: 16}]}>
                  {title}
                </Text>
              </Wrapper>
            </Wrapper>
          ...
          {right ? (
            ...
            <Wrapper flex={1} alignItemsFlexEnd>
              <Icon
                ...
                type={iconTypeRight}
                size={iconSizeRight ? iconSizeRight : sizes.icons.medium}
                color={iconColorRight ? iconColorRight : colors.appBgColor3}
                iconStyle={iconStyleRight}
                onPress={onPressIconRight}
              />
            </Wrapper>
...
export {Colored, Bordered, Underlined, SearchBar, ColoredNew};
